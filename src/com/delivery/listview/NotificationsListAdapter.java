...
public class NotificationsListAdapter extends BaseAdapter {
	...
	private ArrayList<NotificationsItem> arryItems;
	
	public NotificationsListAdapter(Context context, ArrayList<NotificationsItem> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            checkBoxItem = (CheckBox) convertView.findViewById(R.id.checkbox_notification);
        ...
        txtTitle = (TextView) convertView.findViewById(R.id.textview_notification);
